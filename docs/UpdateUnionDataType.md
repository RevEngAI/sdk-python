...
json = "{}"
# create an instance of UpdateUnionDataType from a JSON string
update_union_data_type_instance = UpdateUnionDataType.from_json(json)
# print the JSON string representation of the object
print(UpdateUnionDataType.to_json())

# convert the object into a dict
update_union_data_type_dict = update_union_data_type_instance.to_dict()
# create an instance of UpdateUnionDataType from a dict
update_union_data_type_from_dict = UpdateUnionDataType.from_dict(update_union_data_type_dict)
```
