...
json = "{}"
# create an instance of TypedefDataType from a JSON string
typedef_data_type_instance = TypedefDataType.from_json(json)
# print the JSON string representation of the object
print(TypedefDataType.to_json())

# convert the object into a dict
typedef_data_type_dict = typedef_data_type_instance.to_dict()
# create an instance of TypedefDataType from a dict
typedef_data_type_from_dict = TypedefDataType.from_dict(typedef_data_type_dict)
```
