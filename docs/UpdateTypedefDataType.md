...
json = "{}"
# create an instance of UpdateTypedefDataType from a JSON string
update_typedef_data_type_instance = UpdateTypedefDataType.from_json(json)
# print the JSON string representation of the object
print(UpdateTypedefDataType.to_json())

# convert the object into a dict
update_typedef_data_type_dict = update_typedef_data_type_instance.to_dict()
# create an instance of UpdateTypedefDataType from a dict
update_typedef_data_type_from_dict = UpdateTypedefDataType.from_dict(update_typedef_data_type_dict)
```
