...
[**v3_batch_add_analysis_tags**](AnalysesBulkActionsApi.md#v3_batch_add_analysis_tags) | **POST** /v3/analyses:batchAddTags | Add tags to multiple analyses.
...
# **v3_batch_add_analysis_tags**
> BulkAddTagsOutputBody v3_batch_add_analysis_tags(bulk_add_tags_input_body)
...
with revengai.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = revengai.AnalysesBulkActionsApi(api_client)
    bulk_add_tags_input_body = revengai.BulkAddTagsInputBody() # BulkAddTagsInputBody | 

    try:
        # Add tags to multiple analyses.
        api_response = api_instance.v3_batch_add_analysis_tags(bulk_add_tags_input_body)
        print("The response of AnalysesBulkActionsApi->v3_batch_add_analysis_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnalysesBulkActionsApi->v3_batch_add_analysis_tags: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_add_tags_input_body** | [**BulkAddTagsInputBody**](BulkAddTagsInputBody.md)|  | 
