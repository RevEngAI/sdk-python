...
unknown_data_type_instance = UnknownDataType.from_json(json)
# print the JSON string representation of the object
print(UnknownDataType.to_json())

# convert the object into a dict
unknown_data_type_dict = unknown_data_type_instance.to_dict()
# create an instance of UnknownDataType from a dict
unknown_data_type_from_dict = UnknownDataType.from_dict(unknown_data_type_dict)
```
