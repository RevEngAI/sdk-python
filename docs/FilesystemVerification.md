...
json = "{}"
# create an instance of FilesystemVerification from a JSON string
filesystem_verification_instance = FilesystemVerification.from_json(json)
# print the JSON string representation of the object
print(FilesystemVerification.to_json())

# convert the object into a dict
filesystem_verification_dict = filesystem_verification_instance.to_dict()
# create an instance of FilesystemVerification from a dict
filesystem_verification_from_dict = FilesystemVerification.from_dict(filesystem_verification_dict)
```
