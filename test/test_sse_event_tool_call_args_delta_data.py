...
class TestSseEventToolCallArgsDeltaData(unittest.TestCase):
    """SseEventToolCallArgsDeltaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SseEventToolCallArgsDeltaData:
        """Test SseEventToolCallArgsDeltaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SseEventToolCallArgsDeltaData`
        """
        model = SseEventToolCallArgsDeltaData()
        if include_optional:
            return SseEventToolCallArgsDeltaData(
                data = None,
                event_id = 56,
                type = ''
            )
    ...
    def testSseEventToolCallArgsDeltaData(self):
        """Test SseEventToolCallArgsDeltaData"""
