...
class TestStageEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StageEvent:
        """Test StageEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StageEvent`
        """
        model = StageEvent()
        if include_optional:
            return StageEvent(
