...
class TestEventCONTEXTCOMPACTED(unittest.TestCase):
    """EventCONTEXTCOMPACTED unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventCONTEXTCOMPACTED:
        ...
        # uncomment below to create an instance of `EventCONTEXTCOMPACTED`
        """
        model = EventCONTEXTCOMPACTED()
        if include_optional:
            return EventCONTEXTCOMPACTED(
                data = { },
    ...
    def testEventCONTEXTCOMPACTED(self):
        """Test EventCONTEXTCOMPACTED"""
