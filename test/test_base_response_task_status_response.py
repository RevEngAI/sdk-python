...
class TestBaseResponseTaskStatusResponse(unittest.TestCase):
    """BaseResponseTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseResponseTaskStatusResponse:
        """Test BaseResponseTaskStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseResponseTaskStatusResponse`
        """
        model = BaseResponseTaskStatusResponse()
        if include_optional:
    ...
    def testBaseResponseTaskStatusResponse(self):
        """Test BaseResponseTaskStatusResponse"""
