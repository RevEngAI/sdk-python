...
class TestEventTOOLCALLEND(unittest.TestCase):
    """EventTOOLCALLEND unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventTOOLCALLEND:
        """Test EventTOOLCALLEND
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventTOOLCALLEND`
        """
        model = EventTOOLCALLEND()
        if include_optional:
