...
class TestBaseResponsePipelineStatusResponse(unittest.TestCase):
    """BaseResponsePipelineStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseResponsePipelineStatusResponse:
        """Test BaseResponsePipelineStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseResponsePipelineStatusResponse`
        """
    ...
    def testBaseResponsePipelineStatusResponse(self):
        """Test BaseResponsePipelineStatusResponse"""
