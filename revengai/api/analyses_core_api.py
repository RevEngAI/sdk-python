...
class AnalysesCoreApi:
    ...
    @validate_call
    def get_analysis_queue_position(
        self,
        analysis_id: Annotated[int, Field(strict=True, ge=1, description="Analysis ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_analysis_queue_position_serialize(
            analysis_id=analysis_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_analysis_queue_position_with_http_info(
        self,
        analysis_id: Annotated[int, Field(strict=True, ge=1, description="Analysis ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_analysis_queue_position_without_preload_content(
        self,
        analysis_id: Annotated[int, Field(strict=True, ge=1, description="Analysis ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_analysis_queue_position_serialize(
        self,
        analysis_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/analyses/{analysis_id}/queue-position',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
