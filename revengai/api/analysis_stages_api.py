...
class AnalysisStagesApi:
    ...
    def get_analysis_stages(
        ...
        _param = self._get_analysis_stages_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BaseResponseAnalysisStagesResponse",
            '422': "BaseResponse",
        }
    ...
    @validate_call
    def get_analysis_stages_with_http_info(
        self,
        analysis_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_analysis_stages_without_preload_content(
        self,
        analysis_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_analysis_stages_serialize(
        self,
        analysis_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/analysis-stages/{analysis_id}',
    ...
    def get_pipeline_status(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BaseResponsePipelineStatusResponse",
            '422': "BaseResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def _get_pipeline_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/analysis-stages/{analysis_id}/pipeline-status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
