...
class CollectionsApi:
    ...
    @validate_call
    def v3_add_collection_binaries(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        add_collection_binaries_input_body: AddCollectionBinariesInputBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param collection_id: (required)
        :type collection_id: int
        :param add_collection_binaries_input_body: (required)
        :type add_collection_binaries_input_body: AddCollectionBinariesInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_add_collection_binaries_serialize(
            collection_id=collection_id,
            add_collection_binaries_input_body=add_collection_binaries_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def v3_add_collection_binaries_with_http_info(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        add_collection_binaries_input_body: AddCollectionBinariesInputBody,
        _request_timeout: Union[
    ...
    @validate_call
    def v3_add_collection_binaries_without_preload_content(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        add_collection_binaries_input_body: AddCollectionBinariesInputBody,
        _request_timeout: Union[
    ...
    def _v3_add_collection_binaries_serialize(
        self,
        collection_id,
        add_collection_binaries_input_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if add_collection_binaries_input_body is not None:
            _body_params = add_collection_binaries_input_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/collections/{collection_id}/binaries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v3_create_collection(
        ...
        :param create_collection_input_body: (required)
        :type create_collection_input_body: CreateCollectionInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_create_collection_serialize(
            create_collection_input_body=create_collection_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateCollectionOutputBody",
            '404': "APIError",
            '422': "APIError",
            '500': "APIError",
        }
    ...
    @validate_call
    def v3_create_collection_with_http_info(
        self,
        create_collection_input_body: CreateCollectionInputBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v3_create_collection_without_preload_content(
        self,
        create_collection_input_body: CreateCollectionInputBody,
        _request_timeout: Union[
            None,
    ...
    def _v3_create_collection_serialize(
        self,
        create_collection_input_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_collection_input_body is not None:
            _body_params = create_collection_input_body
    ...
    def v3_get_collection(
        ...
        _param = self._v3_get_collection_serialize(
            collection_id=collection_id,
            include_tags=include_tags,
            include_binaries=include_binaries,
            page_size=page_size,
    ...
    @validate_call
    def v3_get_collection_without_preload_content(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        include_tags: Optional[StrictBool] = None,
        include_binaries: Optional[StrictBool] = None,
    ...
    def _v3_get_collection_serialize(
        self,
        collection_id,
        include_tags,
        include_binaries,
    ...
    @validate_call
    def v3_patch_collection_binaries(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        ...
        :param collection_id: (required)
        :type collection_id: int
        :param patch_collection_binaries_input_body: (required)
        :type patch_collection_binaries_input_body: PatchCollectionBinariesInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_patch_collection_binaries_serialize(
            collection_id=collection_id,
            patch_collection_binaries_input_body=patch_collection_binaries_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PatchCollectionBinariesOutputBody",
            '403': "APIError",
            '404': "APIError",
            '422': "APIError",
            '500': "APIError",
    ...
    @validate_call
    def v3_patch_collection_binaries_without_preload_content(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        patch_collection_binaries_input_body: PatchCollectionBinariesInputBody,
        _request_timeout: Union[
    ...
    def _v3_patch_collection_binaries_serialize(
        self,
        collection_id,
        patch_collection_binaries_input_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if patch_collection_binaries_input_body is not None:
            _body_params = patch_collection_binaries_input_body
    ...
    def v3_patch_collection_tags(
        ...
        :param collection_id: (required)
        :type collection_id: int
        :param patch_collection_tags_input_body: (required)
        :type patch_collection_tags_input_body: PatchCollectionTagsInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_patch_collection_tags_serialize(
            collection_id=collection_id,
            patch_collection_tags_input_body=patch_collection_tags_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PatchCollectionTagsOutputBody",
            '403': "APIError",
            '404': "APIError",
            '422': "APIError",
            '500': "APIError",
    ...
    @validate_call
    def v3_patch_collection_tags_with_http_info(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        patch_collection_tags_input_body: PatchCollectionTagsInputBody,
        _request_timeout: Union[
    ...
    @validate_call
    def v3_patch_collection_tags_without_preload_content(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        patch_collection_tags_input_body: PatchCollectionTagsInputBody,
        _request_timeout: Union[
    ...
    def _v3_patch_collection_tags_serialize(
        self,
        collection_id,
        ...
        # process the form parameters
        # process the body parameter
        if patch_collection_tags_input_body is not None:
            _body_params = patch_collection_tags_input_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v3/collections/{collection_id}/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v3_remove_collection_binaries(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        remove_collection_binaries_input_body: RemoveCollectionBinariesInputBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param collection_id: (required)
        :type collection_id: int
        :param remove_collection_binaries_input_body: (required)
        :type remove_collection_binaries_input_body: RemoveCollectionBinariesInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_remove_collection_binaries_serialize(
            collection_id=collection_id,
            remove_collection_binaries_input_body=remove_collection_binaries_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def v3_remove_collection_binaries_with_http_info(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        remove_collection_binaries_input_body: RemoveCollectionBinariesInputBody,
        _request_timeout: Union[
    ...
    @validate_call
    def v3_remove_collection_binaries_without_preload_content(
        self,
        collection_id: Annotated[int, Field(strict=True, ge=1)],
        remove_collection_binaries_input_body: RemoveCollectionBinariesInputBody,
        _request_timeout: Union[
    ...
    def _v3_remove_collection_binaries_serialize(
        self,
        collection_id,
        remove_collection_binaries_input_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if remove_collection_binaries_input_body is not None:
            _body_params = remove_collection_binaries_input_body
