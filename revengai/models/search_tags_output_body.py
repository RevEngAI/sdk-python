...
class SearchTagsOutputBody(BaseModel):
    """
    ...
    page_size: StrictInt
    results: Optional[List[TagSearchResultBody]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [TagSearchResultBody.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
