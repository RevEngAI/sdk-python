...
class BulkAddTagsOutputBody(BaseModel):
    """
    BulkAddTagsOutputBody
    """ # noqa: E501
    results: Optional[List[BulkAddTagsResultBody]] = Field(description="One entry per requested analysis, in the order they were given")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BulkAddTagsResultBody.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
