...
class Team(BaseModel):
    ...
    def plan_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Free', 'Individual', 'Tester', 'Organisation', 'unknown_default_open_api']):
            raise ValueError("must be one of enum values ('Free', 'Individual', 'Tester', 'Organisation', 'unknown_default_open_api')")
        return value
