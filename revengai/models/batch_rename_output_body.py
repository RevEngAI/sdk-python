...
class BatchRenameOutputBody(BaseModel):
    """
    ...
    renamed_count: StrictInt = Field(description="Number of functions renamed")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["$schema", "renamed_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "renamed_count": obj.get("renamed_count")
        })
