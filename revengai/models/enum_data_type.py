...
class EnumDataType(BaseModel):
    ...
    definition: Optional[EnumDefinition] = Field(default=None, description="Absent only for a type referenced but never defined.")
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ENUM', 'unknown_default_open_api']):
            raise ValueError("must be one of enum values ('ENUM', 'unknown_default_open_api')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definition": EnumDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
