...
class CanonicalizeNamesOutputBody(BaseModel):
    """
    CanonicalizeNamesOutputBody
    """ # noqa: E501
    results: Optional[List[CanonicalName]] = Field(description="Canonicalized names in the same order as the input.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [CanonicalName.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
