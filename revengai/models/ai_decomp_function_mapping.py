...
class AIDecompFunctionMapping(BaseModel):
    """
    AIDecompFunctionMapping
    """ # noqa: E501
    fields: Dict[str, Dict[str, ReplacementValue]]
    inverse_function_map: Dict[str, AIDecompInverseFunctionMapItem]
    inverse_string_map: Dict[str, AIDecompInverseStringMapItem]
    unmatched_custom_function_pointers: Dict[str, ReplacementValue]
    unmatched_custom_types: Dict[str, ReplacementValue]
    unmatched_enums: Dict[str, ReplacementValue]
    unmatched_external_vars: Dict[str, ReplacementValue]
    unmatched_functions: Dict[str, ReplacementValue]
    unmatched_global_vars: Dict[str, ReplacementValue]
    unmatched_go_to_labels: Dict[str, ReplacementValue]
    unmatched_strings: Dict[str, ReplacementValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": dict(
                (_k, dict(
                    (_ik, ReplacementValue.from_dict(_iv))
            ...
            "unmatched_custom_function_pointers": dict(
                (_k, ReplacementValue.from_dict(_v))
