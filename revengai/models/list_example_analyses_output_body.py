...
class ListExampleAnalysesOutputBody(BaseModel):
    """
    ListExampleAnalysesOutputBody
    """ # noqa: E501
    analyses: Optional[List[Example]] = Field(description="List of example analyses")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if analyses (nullable) is None
        # and model_fields_set contains the field
        if self.analyses is None and "analyses" in self.model_fields_set:
            _dict['analyses'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analyses": [Example.from_dict(_item) for _item in obj["analyses"]] if obj.get("analyses") is not None else None
        })
