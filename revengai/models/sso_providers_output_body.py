...
class SSOProvidersOutputBody(BaseModel):
    """
    SSOProvidersOutputBody
    """ # noqa: E501
    providers: Optional[List[SSOProvider]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [SSOProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
