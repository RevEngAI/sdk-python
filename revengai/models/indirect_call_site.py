...
class IndirectCallSite(BaseModel):
    """
    IndirectCallSite
    """ # noqa: E501
    callee_function_id: Optional[StrictInt] = None
    inst_vaddr: StrictInt = Field(description="Vaddr of the indirect call instruction.")
    is_external: StrictBool
    target_name: Optional[StrictStr] = None
    target_vaddr: StrictInt = Field(description="Resolved call target vaddr.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["callee_function_id", "inst_vaddr", "is_external", "target_name", "target_vaddr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inst_vaddr": obj.get("inst_vaddr"),
            "is_external": obj.get("is_external"),
            "target_name": obj.get("target_name"),
            "target_vaddr": obj.get("target_vaddr")
        })
