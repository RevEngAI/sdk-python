...
class OperationMetadataCapabilitiesResult(BaseModel):
    """
    ...
    metadata: Optional[Metadata] = Field(default=None, description="In-flight information and details.")
    name: StrictStr = Field(description="API resource name.")
    response: Optional[CapabilitiesResult] = Field(default=None, description="Result, set only when done is true and the operation succeeded.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "response": CapabilitiesResult.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
