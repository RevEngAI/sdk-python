...
class RemoveCollectionBinariesInputBody(BaseModel):
    """
    RemoveCollectionBinariesInputBody
    """ # noqa: E501
    binaries: Optional[List[StrictInt]] = Field(description="Binary IDs to remove from the collection. Binary IDs not linked to the collection are ignored.")
