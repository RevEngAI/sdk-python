...
class EnumDefinition(BaseModel):
    ...
    EnumDefinition
    """ # noqa: E501
    values: Optional[List[DataTypeEnumValueEntry]] = Field(description="The type's constants.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [DataTypeEnumValueEntry.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
