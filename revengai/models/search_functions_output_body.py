...
class SearchFunctionsOutputBody(BaseModel):
    """
    ...
    page_size: StrictInt
    results: Optional[List[FunctionSearchResultBody]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [FunctionSearchResultBody.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
