...
class TriggerRenameUnnamedFunctionsInputBody(BaseModel):
    """
    TriggerRenameUnnamedFunctionsInputBody
    """ # noqa: E501
    limit: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Stop after this many functions. Omit to process every unnamed function in the analysis.")
