...
class BaseResponseCapabilitiesAgentResponse(BaseModel):
    """
    ...
    data: Optional[CapabilitiesAgentResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CapabilitiesAgentResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
