...
class DataTypeFunctionParameterEntry(BaseModel):
    """
    DataTypeFunctionParameterEntry
    """ # noqa: E501
    data_type_id: Optional[StrictInt] = Field(default=None, description="The parameter's type.")
    name: Optional[StrictStr] = Field(default=None, description="Parameter name, when the producer had one.")
    ordinal: StrictInt = Field(description="Zero-based argument position.")
    size: StrictInt = Field(description="Parameter size in bytes.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data_type_id", "name", "ordinal", "size"]
