...
class CanonicalName(BaseModel):
    ...
    CanonicalName
    """ # noqa: E501
    canonical_name: StrictStr = Field(description="Canonical form of the name, or the input name itself when it has no canonical form.")
    name: StrictStr = Field(description="The input function name.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["canonical_name", "name"]
