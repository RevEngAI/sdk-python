...
class CapabilitiesResult(BaseModel):
    ...
    CapabilitiesResult
    """ # noqa: E501
    capabilities: Optional[List[Capability]] = Field(description="Capabilities found. A capability whose address no longer resolves within the analysis is omitted.")
