...
class RenameAppliedEvent(BaseModel):
    """
    RenameAppliedEvent
    """ # noqa: E501
    addr_hex: Optional[StrictStr] = None
    attempt: StrictInt
    new_name: StrictStr
    old_name: StrictStr
    seq: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["addr_hex", "attempt", "new_name", "old_name", "seq", "type"]
