...
class OperationCreateMetadataCreateResult(BaseModel):
    """
    ...
    metadata: Optional[CreateMetadata] = Field(default=None, description="In-flight information and details.")
    name: StrictStr = Field(description="API resource name.")
    response: Optional[CreateResult] = Field(default=None, description="Result, set only when done is true and the operation succeeded.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": CreateMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": obj.get("name"),
            "response": CreateResult.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
