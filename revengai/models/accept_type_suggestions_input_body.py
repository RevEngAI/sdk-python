...
class AcceptTypeSuggestionsInputBody(BaseModel):
    """
    AcceptTypeSuggestionsInputBody
    """ # noqa: E501
    keys: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=100)]] = Field(description="Keys of the suggestions to store, as the type suggestions endpoint returns them. A key repeated in one request is stored once.")
