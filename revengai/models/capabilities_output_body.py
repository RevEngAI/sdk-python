...
class CapabilitiesOutputBody(BaseModel):
    """
    CapabilitiesOutputBody
    """ # noqa: E501
    capabilities: Optional[List[CapabilityEntry]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": [CapabilityEntry.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None
        })
