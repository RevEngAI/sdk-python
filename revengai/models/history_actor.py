...
class HistoryActor(BaseModel):
    ...
    HistoryActor
    """ # noqa: E501
    user_id: StrictInt = Field(description="The user who made the change.")
    username: Optional[StrictStr] = Field(default=None, description="Absent when the user no longer exists.")
