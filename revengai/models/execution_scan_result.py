...
class ExecutionScanResult(BaseModel):
    """
    ExecutionScanResult
    """ # noqa: E501
    analysis_id: StrictInt = Field(description="Analysis the run was performed against")
    findings: Optional[List[ExecutionFinding]] = Field(default=None, description="Functions with execution-related evidence, sorted by whether they execute code, then confidence, then evidence count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "findings": [ExecutionFinding.from_dict(_item) for _item in obj["findings"]] if obj.get("findings") is not None else None,
