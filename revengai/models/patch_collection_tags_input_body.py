...
class PatchCollectionTagsInputBody(BaseModel):
    """
    PatchCollectionTagsInputBody
    """ # noqa: E501
    tags: Optional[List[StrictStr]] = Field(description="Tags to set on the collection. The collection's tags are fully replaced with this list.")
