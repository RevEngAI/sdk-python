...
class AddIssuerDomainInputBody(BaseModel):
    """
    AddIssuerDomainInputBody
    """ # noqa: E501
    domain: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Email domain to allow (e.g. acme.com)")
