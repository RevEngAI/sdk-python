...
class Finding(BaseModel):
    ...
    Finding
    """ # noqa: E501
    property_id: Optional[StrictStr] = ''
    reachability: Optional[ReportReachabilityStatus] = None
    evidence: Optional[List[FindingEvidenceInner]] = None
    __properties: ClassVar[List[str]] = ["property_id", "reachability", "evidence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property_id": obj.get("property_id") if obj.get("property_id") is not None else '',
            "reachability": obj.get("reachability"),
            "evidence": [FindingEvidenceInner.from_dict(_item) for _item in obj["evidence"]] if obj.get("evidence") is not None else None
        })
        return _obj
