...
class AnalysisTagBody(BaseModel):
    """
    AnalysisTagBody
    """ # noqa: E501
    collection_id: Optional[StrictInt] = Field(description="Collection this tag maps to, or null")
    name: StrictStr = Field(description="Tag name")
    origin: StrictStr = Field(description="Origin of the tag")
