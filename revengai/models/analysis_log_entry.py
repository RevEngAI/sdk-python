...
class AnalysisLogEntry(BaseModel):
    ...
    AnalysisLogEntry
    """ # noqa: E501
    level: StrictStr = Field(description="Severity")
    source: StrictStr = Field(description="Component that emitted the line")
    text: StrictStr = Field(description="Log line text")
    timestamp: datetime = Field(description="When the line was emitted (UTC)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["level", "source", "text", "timestamp"]
