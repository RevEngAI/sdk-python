...
class GetProductsOutputBody(BaseModel):
    """
    GetProductsOutputBody
    """ # noqa: E501
    products: Optional[List[ProductOutput]] = Field(description="List of available products")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [ProductOutput.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
