...
class OrganisationOwner(BaseModel):
    """
    OrganisationOwner
    """ # noqa: E501
    created_at: datetime
    organisation_id: StrictInt
    organisation_owner_id: StrictInt
    user_id: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "organisation_id", "organisation_owner_id", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organisation_owner_id": obj.get("organisation_owner_id"),
