...
class SearchBinariesOutputBody(BaseModel):
    """
    ...
    page_size: StrictInt
    results: Optional[List[BinarySearchResultBody]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [BinarySearchResultBody.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
