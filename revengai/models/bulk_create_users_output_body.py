...
class BulkCreateUsersOutputBody(BaseModel):
    """
    BulkCreateUsersOutputBody
    """ # noqa: E501
    failed: StrictInt
    results: Optional[List[BulkCreateUserResult]]
    succeeded: StrictInt
    total: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["failed", "results", "succeeded", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [BulkCreateUserResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
