...
class ListAnalysisFunctionsOutputBody(BaseModel):
    """
    ListAnalysisFunctionsOutputBody
    """ # noqa: E501
    functions: Optional[List[AnalysisFunctionEntry]]
    total_count: StrictInt = Field(description="Total functions in the analysis, ignoring pagination.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["functions", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "functions": [AnalysisFunctionEntry.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None,
