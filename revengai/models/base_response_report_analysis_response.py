...
class BaseResponseReportAnalysisResponse(BaseModel):
    """
    ...
    data: Optional[ReportAnalysisResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ReportAnalysisResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
