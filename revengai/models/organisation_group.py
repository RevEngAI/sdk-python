...
class OrganisationGroup(BaseModel):
    """
    OrganisationGroup
    """ # noqa: E501
    created_at: datetime
    name: Optional[StrictStr]
    organisation_group_id: StrictInt
    organisation_id: StrictInt
    team_id: StrictInt
    updated_at: datetime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "name", "organisation_group_id", "organisation_id", "team_id", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "organisation_group_id": obj.get("organisation_group_id"),
