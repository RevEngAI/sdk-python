...
class AnalysisCapabilityBody(BaseModel):
    """
    AnalysisCapabilityBody
    """ # noqa: E501
    capabilities: Optional[List[StrictStr]] = Field(description="Capabilities attributed to the function")
    function_name: StrictStr = Field(description="Name of the function the capability was found in")
    function_vaddr: StrictInt = Field(description="Virtual address of that function")
