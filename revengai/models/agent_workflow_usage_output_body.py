...
class AgentWorkflowUsageOutputBody(BaseModel):
    """
    AgentWorkflowUsageOutputBody
    """ # noqa: E501
    report: Optional[List[WorkflowDayBody]] = Field(description="One entry per day in the requested window, oldest first")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": [WorkflowDayBody.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
