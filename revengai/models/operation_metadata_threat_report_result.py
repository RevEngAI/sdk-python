...
class OperationMetadataThreatReportResult(BaseModel):
    """
    ...
    response: Optional[ThreatReportResult] = Field(default=None, description="Result, set only when done is true and the operation succeeded.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "response": ThreatReportResult.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
