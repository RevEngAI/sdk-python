...
class TriageResult(BaseModel):
    ...
    TriageResult
    """ # noqa: E501
    functions: Optional[List[TriageFunction]] = Field(description="Per-function assessments. A function whose address no longer resolves within the analysis is omitted.")
    software_score: Union[StrictFloat, StrictInt] = Field(description="Maliciousness score for the binary, 0 to 1")
    summary: StrictStr = Field(description="Summary of the triage assessment")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["functions", "software_score", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "functions": [TriageFunction.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None,
