...
class UpdateTagsInputBody(BaseModel):
    """
    UpdateTagsInputBody
    """ # noqa: E501
    tags: Optional[List[StrictStr]] = Field(description="The complete set of user tags the analysis' binary should carry after this call")
