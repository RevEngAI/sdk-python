...
class ReferencedConstant(BaseModel):
    """
    ReferencedConstant
    """ # noqa: E501
    subject: Subject
    ...
    __properties: ClassVar[List[str]] = ["subject", "value", "display"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": BytesConstant.from_dict(obj["value"]) if obj.get("value") is not None else None,
