...
class UpdateUserPasswordInputBody(BaseModel):
    """
    UpdateUserPasswordInputBody
    """ # noqa: E501
    current_password: Optional[StrictStr] = Field(default=None, description="Current password (required when changing your own password; ignored for SUPERADMIN updates of other users)")
    new_password: Annotated[str, Field(min_length=10, strict=True)] = Field(description="New password (minimum 10 characters)")
