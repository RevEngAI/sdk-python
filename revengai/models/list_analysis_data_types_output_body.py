...
class ListAnalysisDataTypesOutputBody(BaseModel):
    """
    ListAnalysisDataTypesOutputBody
    """ # noqa: E501
    items: Optional[List[DataTypeEntry]]
    total_count: StrictInt = Field(description="Total types matching the filters, ignoring pagination.")
