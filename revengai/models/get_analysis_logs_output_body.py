...
class GetAnalysisLogsOutputBody(BaseModel):
    """
    GetAnalysisLogsOutputBody
    """ # noqa: E501
    entries: Optional[List[AnalysisLogEntry]] = Field(description="Analysis log lines, oldest first")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [AnalysisLogEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
