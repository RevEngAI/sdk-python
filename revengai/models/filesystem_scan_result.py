...
class FilesystemScanResult(BaseModel):
    """
    FilesystemScanResult
    """ # noqa: E501
    analysis_id: StrictInt = Field(description="Analysis the run was performed against")
    findings: Optional[List[FilesystemFinding]] = Field(default=None, description="Functions with filesystem-related evidence, sorted by whether they modify the filesystem, then confidence, then evidence count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "findings": [FilesystemFinding.from_dict(_item) for _item in obj["findings"]] if obj.get("findings") is not None else None,
