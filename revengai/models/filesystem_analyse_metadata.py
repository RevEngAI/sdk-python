...
class FilesystemAnalyseMetadata(BaseModel):
    """
    ...
    status: StrictStr = Field(description="Run status. UNINITIALISED means the agent has never been triggered for this function.")
