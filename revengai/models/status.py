...
class Status(BaseModel):
    ...
    retryable: StrictBool = Field(description="Whether retrying the operation might succeed.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "detail", "doc_url", "message", "retryable"]
