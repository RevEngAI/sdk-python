...
class Status(BaseModel):
    ...
    Status
    """ # noqa: E501
    code: StrictStr = Field(description="Machine-readable error code, shared with synchronous API errors.")
