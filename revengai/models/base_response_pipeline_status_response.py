...
class BaseResponsePipelineStatusResponse(BaseModel):
    """
    BaseResponsePipelineStatusResponse
    """ # noqa: E501
    data: Optional[PipelineStatusResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PipelineStatusResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
