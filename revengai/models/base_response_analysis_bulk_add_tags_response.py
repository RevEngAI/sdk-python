...
class BaseResponseAnalysisBulkAddTagsResponse(BaseModel):
    """
    BaseResponseAnalysisBulkAddTagsResponse
    """ # noqa: E501
    data: Optional[AnalysisBulkAddTagsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AnalysisBulkAddTagsResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
