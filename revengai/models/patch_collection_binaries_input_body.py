...
class PatchCollectionBinariesInputBody(BaseModel):
    """
    PatchCollectionBinariesInputBody
    """ # noqa: E501
    binaries: Optional[List[StrictInt]] = Field(description="Binary IDs to set on the collection. The collection's binaries are fully replaced with this list.")
