...
class FunctionSimilarityEvidence(BaseModel):
    """
    Function-similarity results suggestive of a capability.
    """ # noqa: E501
    evidence_kind: Optional[StrictStr] = 'function_similarity'
    kind: Optional[StrictStr] = 'deterministic_derivation'
    effect: EvidenceEffect
    strength: Optional[StrictStr] = 'indirect'
    similarities: Annotated[List[FunctionSimilarity], Field(min_length=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["evidence_kind", "kind", "effect", "strength", "similarities"]
    ...
    def evidence_kind_validate_enum(cls, value):
        ...
        if value not in set(['function_similarity', 'unknown_default_open_api']):
            raise ValueError("must be one of enum values ('function_similarity', 'unknown_default_open_api')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in similarities (list)
        _items = []
        if self.similarities:
            for _item_similarities in self.similarities:
                if _item_similarities:
                    _items.append(_item_similarities.to_dict())
            _dict['similarities'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evidence_kind": obj.get("evidence_kind") if obj.get("evidence_kind") is not None else 'function_similarity',
            ...
            "similarities": [FunctionSimilarity.from_dict(_item) for _item in obj["similarities"]] if obj.get("similarities") is not None else None
        })
