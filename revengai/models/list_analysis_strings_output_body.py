...
class ListAnalysisStringsOutputBody(BaseModel):
    """
    ListAnalysisStringsOutputBody
    """ # noqa: E501
    strings: Optional[List[AnalysisStringItem]]
    total_strings: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "strings": [AnalysisStringItem.from_dict(_item) for _item in obj["strings"]] if obj.get("strings") is not None else None,
